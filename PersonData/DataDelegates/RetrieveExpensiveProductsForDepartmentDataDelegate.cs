...
{
   internal class RetrieveExpensiveProductsForDepartmentDataDelegate : DataReaderDelegate<IReadOnlyList<Product>>
   {
      private readonly int departmentID;

      public RetrieveExpensiveProductsForDepartmentDataDelegate(int departmentID)
         : base("Stores.ExpensiveItems") //name of procedure
      {
