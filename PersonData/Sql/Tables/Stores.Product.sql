IF OBJECT_ID(N'Stores.Product') IS NULL
BEGIN
   CREATE TABLE Stores.Product
	(
		...
		CONSTRAINT [FK_Stores_Product_StoreID] FOREIGN KEY(StoreID) REFERENCES Stores.Store(StoreID),
		CONSTRAINT [FK_Stores_Product_DepartmentID] FOREIGN KEY(DepartmentID) REFERENCES Stores.Department(DepartmentID),
