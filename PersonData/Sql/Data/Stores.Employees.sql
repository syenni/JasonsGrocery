...
FROM 
	(
		VALUES	
			...
			(N'Cashier', N'Deli', 11, N'Denzel Washington'),
			(N'Clerk', N'Dairy', 10.50, N'Dave Chappelle'),
			(N'Cashier', N'Dairy', 11.50, N'Kevin Hart'),
			(N'Cashier', N'Produce', 10.75, N'Post Malone'),
			(N'Clerk', N'Produce', 9, N'Paul Rudd'),
			(N'Clerk', N'Bakery', 10, N'Ben Stiller'),
			(N'Cashier', N'Bakery', 8.25, N'Slenderman'),
